...
export function OpenFeedCommentComposer({
  ...
  return (
    <div className="border-b border-social-border px-4 py-3" aria-busy={busy}>
      {isRootDraft ? (
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="mt-2 flex items-center justify-end gap-2 border-t border-social-border pt-2">
            ...
            <button
              ...
              className="min-h-11 rounded-full bg-social-blue px-5 text-sm font-bold text-white transition enabled:hover:bg-social-blue/90 aria-disabled:opacity-50"
            >
