...
export function BookfaceCommentComposer({
  ...
  return (
    <div className="px-4 py-2" aria-busy={busy || undefined}>
      {isRootDraft ? (
      ...
      <div className="flex items-center gap-2">
        ...
        <div className="flex min-w-0 flex-1 items-center gap-1 rounded-full bg-bf-chip pl-3 pr-1">
          ...
          <button
            ...
            className="grid min-h-11 min-w-11 place-items-center rounded-full text-bf-blue transition-colors hover:bg-bf-border aria-disabled:opacity-40 disabled:opacity-40"
          >
