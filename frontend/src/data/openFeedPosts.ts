...
export const openFeedPosts: OpenFeedPost[] = [
    ...
    seedComments: [
      {
        ...
        handle: "@sam.r",
        body: {
          en: "Saving a seat — thanks for hosting this.",
          es: "Reservo lugar — gracias por organizarlo.",
        },
    ...
    seedComments: [
      {
        ...
        handle: "@eve.s",
        body: {
          en: "Anyone know which neighborhood this is?",
          es: "¿Alguien sabe de qué barrio es?",
        },
      ...
      },
      {
        ...
        handle: "@omar.h",
        body: {
          en: "Sharing so neighbors stay safe.",
          es: "Comparto para que los vecinos estén alerta.",
        },
  ...
  },
  {
    ...
    body: {
      en: "Proof from today’s disaster in our city. People are already helping out. #flood",
      es: "Prueba del desastre de hoy en nuestra ciudad. La gente ya está ayudando. #inundación",
    },
    category: "environment",
    tone: "ambiguous",
    mediaKind: "photo",
    ...
    seedComments: [
      {
        ...
        handle: "@cal.j",
        body: {
          en: "Where was this taken?",
          es: "¿Dónde se tomó esto?",
        },
